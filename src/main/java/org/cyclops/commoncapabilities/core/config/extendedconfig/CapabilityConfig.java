package org.cyclops.commoncapabilities.core.config.extendedconfig;

import net.minecraftforge.common.capabilities.Capability;
import org.cyclops.commoncapabilities.CommonCapabilities;
import org.cyclops.commoncapabilities.core.config.ExtendedConfigurableType;
...
public abstract class CapabilityConfig<T> extends ExtendedConfig<CapabilityConfig<T>> {
    ...
    public CapabilityConfig(boolean enabled, String namedId, String comment,
        ...
        super(CommonCapabilities._instance, enabled, namedId, comment, null);
        this.type = type;
